...
public class LoadParticipationAVenirAsyncTask extends AsyncTask <String, Void, List<Participation>> {
    ...
    private final String URI = Globals.getInstance().getBaseUrl() + "participation/all-a-venir/utilisateur/3";
    private ParticipationAVenirFragment fragment;

    public LoadParticipationAVenirAsyncTask(ParticipationAVenirFragment fragment) {
    ...
    protected List<Participation> doInBackground(String... params) {
        ...
        AllParticipationEvent allParticipationEvent = restTemplate.getForObject( URI, AllParticipationEvent.class);
